...
var F = (i, t, l) =>
    t in i
      ? z(i, t, { enumerable: !0, configurable: !0, writable: !0, value: l })
      : (i[t] = l),
  B = (i, t) => {
    for (var l in t || (t = {})) G.call(t, l) && F(i, l, t[l]);
    if (E) for (var l of E(t)) U.call(t, l) && F(i, l, t[l]);
    return i;
  },
  C = (i, t) => L(i, O(t));
import {
...
const ie = '_operations_1u3vd_11';
var h = {
    'button-group': '_button-group_1u3vd_1',
    'search-row': '_search-row_1u3vd_6',
    operations: ie,
  },
  s =
...
function Ne() {
  const [i] = r.useForm(),
    ...
    [c, j] = a.exports.useState(1),
    [p, w] = a.exports.useState(10),
    [S, y] = a.exports.useState(0),
    [N, P] = a.exports.useState(''),
  ...
  a.exports.useEffect(() => {
    ...
    return (
      ...
      W({
        page: c,
        pageSize: p,
        permissionCode: N || void 0,
        permissionName: N || void 0,
      })
        .then((o) => {
