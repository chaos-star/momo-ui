...
/* empty css               */ /* empty css               */ /* empty css              */ import { u as I } from './index.04d9875a.js';
...
function M() {
  ...
  const k = [
    { title: a['workplace.column.rank'], dataIndex: 'rank', width: 65 },
    {
      ...
      dataIndex: 'title',
      render: (e) =>
        t(p.Paragraph, { style: { margin: 0 }, ellipsis: !0, children: e }),
    },
    {
  ...
  return n(f, {
    children: [
      n('div', {
        ...
        children: [
          t(p.Title, { heading: 6, children: a['workplace.popularContents'] }),
