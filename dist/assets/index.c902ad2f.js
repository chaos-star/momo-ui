...
function Ze() {
  ...
  const ne = (t) => {
      b(t), l.setFieldValue('logoType', t);
      const i = l.getFieldValue('logoSvgElement');
      S(typeof i == 'string' ? i : '');
    },
    W = (t) => (t.size > qe ? (v.warning(a.logoSizeExceeded), !1) : !0),
    J = async (t) => {
      k(!0);
      try {
        const i = Oe(await we('logo', t)),
          r = E(
            _(c({}, N), {
    ...
    re = async ({ file: t, onSuccess: i, onError: r }) => {
      try {
        const g = await J(t);
        i(g);
      } catch (g) {
    ...
    ue = async (t) => {
      ...
      (t.target.value = ''), !(!i || !W(i)) && (await J(i));
    },
    me = () => {
      if (!O) {
        v.warning(a.noLogoUrl);
        return;
      }
      Ce(O), v.success(a.logoUrlCopied);
    },
    ce = (t) => {
      var i;
      t.stopPropagation(), (i = M.current) == null || i.click();
    },
    ge = async () => {
      const t = await l.validate();
      q(!0);
      try {
        const i = E(await Te(se(t))),
          r = R(i);
        C(i),
          b(r.logoType || d),
          S(r.logoSvgElement || ''),
              ...
              e.exports.jsxDEV(
                'div',
                {
                  children: [
                    e.exports.jsxDEV(
                      D.Title,
                      { heading: 5, className: u.title, children: a.pageTitle },
                      void 0,
                      !1,
                    ...
                    y,
                    {
                      ...
                      children: e.exports.jsxDEV(
                        Y,
                        {
                          ...
                          className: u.card,
                          children: ee.map((t) => {
                            const i = I('systemName', t.key),
                              r = I('companyName', t.key),
                              g = I('systemDescription', t.key);
                            return e.exports.jsxDEV(
                              'div',
                              {
