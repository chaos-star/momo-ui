import { r as p, u as d, j as i, s as j } from './vendor.3ac9a823.js';
import { b as v } from './index.2a9369a5.js';
const h = (e) => {
    ...
    const s = () => {
      ...
      c &&
        ...
        r
          ...
          .forEach((l, f) => {
            l.setAttribute('id', `${t}-page-size-input-${f}`),
              l.setAttribute('name', `${t}-page-size-input-${f}`);
          });
    };
    s();
