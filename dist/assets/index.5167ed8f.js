...
/* empty css               */ /* empty css               */ /* empty css               */ /* empty css               */ /* empty css              */ import {
  u as je,
  P as ye,
} from './useArcoPaginationFieldIds.8b2b3833.js';
import { a as S, u as Ve, b as ge } from './index.8a32a122.js';
import { l as Te, S as Ie } from './form.02487823.js';
import { a as g, A as T } from './ArcoSelectInputIds.827e584e.js';
...
function Ze() {
  const e = Ve(Te),
    ...
    [D, q] = l.exports.useState(1),
    [j, te] = l.exports.useState(10),
    [I, se] = l.exports.useState(0),
    le = l.exports.useMemo(
      () => ({
        sizeCanChange: !0,
        showTotal: !0,
        pageSize: j,
    ...
    [B, P] = l.exports.useState(!0),
    [R, ie] = l.exports.useState({}),
    [re, oe] = l.exports.useState(0),
    [A, C] = l.exports.useState([]),
    [ne, L] = l.exports.useState(!1),
    [me, k] = l.exports.useState(!1),
    [i, K] = l.exports.useState(null),
    w = l.exports.useRef(null),
    z = l.exports.useRef(null);
  je(z, 'app-list-pagination', D, j, I, B),
    l.exports.useEffect(() => {
      if (!p) {
        C([]);
        return;
  ...
  const h = l.exports.useCallback(() => oe((s) => s + 1), []),
    ue = (s) => {
      q(1), ie(s);
    },
    pe = (s) => {
                    ...
                    data: [
                      ...
                      },
                      {
                        ...
                        value: i.partnerId
                          ? a.exports.jsxDEV(
                              v.Text,
                              { copyable: !0, children: i.partnerId },
                              void 0,
                              !1,
                              {
                                fileName: t,
                      ...
                      {
                        label: e['appSearch.field.partnerSecret'],
                        value: i.partnerSecret
                          ? a.exports.jsxDEV(
                              v.Text,
                              { copyable: !0, children: i.partnerSecret },
                              void 0,
                              !1,
                              {
                                fileName: t,
