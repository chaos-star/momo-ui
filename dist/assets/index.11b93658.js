...
/* empty css               */ /* empty css               */ /* empty css               */ /* empty css               */ /* empty css              */ import { P as Ae } from './index.7e565d94.js';
import { a as g, u as Ce, b as Le } from './index.04d9875a.js';
import { l as ke, S as Ne } from './form.c0262afa.js';
...
function ea() {
  ...
  const b = r.exports.useCallback(() => ne((t) => t + 1), []),
    ce = (t) => {
      B(1), le(t);
    },
    de = (t) => {
      ...
      () => ({
        ...
        onDelete: (t) => {
          v.confirm({
            ...
            onOk: async () => {
              await je(t.id), C.success(e['appSearch.msg.deleteOk']), b();
            },
          });
        },
        onEnable: (t) => {
