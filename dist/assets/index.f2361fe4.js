    ...
    g.exports.useLayoutEffect(() => {
      ...
      const l =
          (d = (i = M.current) == null ? void 0 : i.getRootDOMNode) == null
            ? void 0
            : d.call(i),
        n = l == null ? void 0 : l.querySelector('input[type="file"]');
      !n || ((n.id = F('logoUpload')), (n.name = 'logoUpload'));
    }, [f]);
  const ue = (l) => {
      P(l), e.setFieldValue('logoType', l);
      const n = e.getFieldValue('logoSvgElement');
      C(typeof n == 'string' ? n : '');
    },
    W = (l) => (l.size > ke ? (v.warning(t.logoSizeExceeded), !1) : !0),
    J = async (l) => {
      z(!0);
      try {
        const n = je(await Re('logo', l)),
          i = S(
            b(c({}, y), {
              config: b(c({}, le(e.getFieldsValue())), {
                logoType: p,
    ...
    re = async ({ file: l, onSuccess: n, onError: i }) => {
      try {
        const d = await J(l);
        n(d);
      } catch (d) {
    ...
    ge = async (l) => {
      var i;
      const n = (i = l.target.files) == null ? void 0 : i[0];
      (l.target.value = ''), !(!n || !W(n)) && (await J(n));
    },
    ce = () => {
      if (!$) {
      ...
      Te($), v.success(t.logoUrlCopied);
    },
    de = (l) => {
      var n;
      l.stopPropagation(), (n = O.current) == null || n.click();
    },
    pe = async () => {
      const l = await e.validate();
      A(!0);
      try {
        const n = S(await Ie(le(l))),
          i = U(n);
        D(n),
          P(i.logoType || p),
          C(i.logoSvgElement || ''),
        ...
        children: [
          r('div', {
            children: [
              ...
              a(L.Text, { type: 'secondary', children: t.pageDescription }),
            ],
          }),
          r(Se, {
            children: [
          ...
          children: [
            a(E, {
              ...
              children: a(H, {
                ...
                className: u.card,
                children: oe.map((l) => {
                  const n = G('systemName', l.key),
                    i = G('companyName', l.key),
                    d = G('systemDescription', l.key);
                  return r(
                    'div',
                    {
                      ...
                      children: [
                        a('div', {
                          ...
                          children: t.languageLabels[l.key],
                        }),
                        r(Z, {
                          gutter: 16,
                          children: [
                            ...
                            a(E, {
                              ...
                              children: a(m.Item, {
                                ...
                                rules: [
                                  {
                                    required: !0,
                                    message: t.systemDescriptionRequired,
                                  },
                                ],
                                children: a(ee, {
                                  id: F(d),
                  ...
                  r(m.Item, {
                    ...
                    children: [
                      r(B.Group, {
                        ...
                        onChange: ue,
                        children: [
                          a(B, { value: ae, children: t.svgPath }),
                          a(B, { value: p, children: t.image }),
                        ],
                      }),
                      a('input', {
                        id: F('logoType'),
                    ...
                    ? r(Q, {
                        children: [
                          a(m.Item, {
                            ...
                            rules: [
                              { required: !0, message: t.logoSvgRequired },
                              { validator: Ke(t) },
                            ],
                            children: a(ee, {
                              id: F('logoSvgElement'),
                              ...
                              onChange: (l) => {
                                C(l), e.setFieldValue('logoSvgElement', l);
                              },
                            }),
                          }),
                          r('div', {
                            ...
                            children: [
                              ...
                              a('div', {
                                ...
                                children: j
                                  ? a('img', { src: j, alt: t.svgPreview })
                                  : a('span', { children: t.noSvgPreview }),
                              }),
                            ],
                          }),
                        ],
                    ...
                    : r(Q, {
                        children: [
                          ...
                          a(m.Item, {
                            ...
                            field: 'logoPath',
                            rules: [
                              { required: !0, message: t.logoPathRequired },
                            ],
                            children: a(N, {
                              className: u.logoPathInput,
                              name: 'logoPath',
                              placeholder: t.logoPathPlaceholder,
                              readOnly: !0,
                              style: { width: '100%' },
                              addAfter: a(w, {
