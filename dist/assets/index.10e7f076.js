...
/* empty css               */ /* empty css               */ /* empty css              */ import { g as L } from './index.97399a5e.js';
import { g as $, b as O } from './access-control.a5391fe6.js';
import { f as z } from './accessControl.941fcf7e.js';
function G(n) {
  return $('/api/system/auth-diagnosis/sources', n);
}
function J(n) {
  return O('/api/system/auth-diagnosis/simulate', n);
}
              ...
              c &&
                e('div', {
                  ...
                  children: l(P, {
                    ...
                    children: [
                      e(y, {
                        color: c.allowed ? 'green' : 'red',
                        children: c.allowed
                          ? '\u5141\u8BB8\u8BBF\u95EE'
                          : '\u62D2\u7EDD\u8BBF\u95EE',
                      }),
                      l(m, { children: ['API\uFF1A', c.apiCode || '-'] }),
                      l(m, {
                        children: [
                          '\u6743\u9650\u7801\uFF1A',
                          c.permissionCode || '-',
