...
/* empty css               */ /* empty css               */ /* empty css               */ /* empty css               */ /* empty css              */ import { P as Ye } from './index.ce1a6509.js';
import { a as p, u as et } from './index.2cec1040.js';
import { e as tt } from './permission-boundary-package.e1788fdc.js';
import { l as at, S as nt } from './form.a056969a.js';
...
function Pt() {
  ...
  st(ie, 'tenant-list-pagination', f, k, Z, J),
    i.exports.useEffect(() => {
      let a = !1;
      return (
        Q(!0),
        ot(ft(X, f, k))
          .then((n) => {
            var s;
            a || (b(n.list || []), Ee((s = n.total) != null ? s : 0));
          })
          .finally(() => {
            a || Q(!1);
          }),
              ...
              children: [
                ...
                n.activeStatus === 1
                  ? t(d, {
                      ...
                      icon: t(Ke, {}),
                      onClick: async () => {
                        await fe({ id: n.id, activeStatus: 2 }),
                          m.success('\u505C\u7528\u6210\u529F'),
                          A((s) => s + 1);
                      },
                      children: '\u505C\u7528',
                  ...
                  : t(d, {
                      ...
                      icon: t(He, {}),
                      onClick: async () => {
                        await fe({ id: n.id, activeStatus: 1 }),
                          m.success('\u542F\u52A8\u6210\u529F'),
                          A((s) => s + 1);
                      },
                      children: '\u542F\u52A8',
      ...
      () => ({
        ...
        onEnable: (a) => {
          S.confirm({
            ...
            onOk: async () => {
              await be({ id: a.id, activeStatus: 1 }),
        ...
        onDisable: (a) => {
          S.confirm({
            ...
            onOk: async () => {
              await be({ id: a.id, activeStatus: 2 }),
                m.success(e['tenantSearch.msg.activeStatusOk']),
                F();
            },
          });
