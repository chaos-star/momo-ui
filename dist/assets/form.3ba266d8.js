...
var E = (r, c, e) =>
    c in r
      ? k(r, c, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (r[c] = e),
  C = (r, c) => {
    for (var e in c || (c = {})) N.call(c, e) && E(r, e, c[e]);
    if (b) for (var e of b(c)) T.call(c, e) && E(r, e, c[e]);
    return r;
  };
import {
  r as g,
...
import { G as O, u as x } from './index.2cec1040.js';
import { a as s, A as d } from './ArcoSelectInputIds.2dc06435.js';
...
const { Row: K, Col: u } = L,
  ...
  h = 'app-search-osType',
  S = 'app-search-activeStatus',
  m = 'app-search-status',
  F = 'app-search-tenantId';
function $(r) {
  const { lang: c } = g.exports.useContext(O),
    e = x(_),
    [f] = R(),
    B = () => {
      const i = f.getFieldsValue();
      r.onSearch(i);
    },
    D = () => {
      f.resetFields(), r.onSearch(C({}, I));
    },
    o = c === 'zh-CN' ? 8 : 12;
  return t('div', {
          ...
          children: [
            r.showTenantFilter
              ? a(u, {
                  span: o,
                  children: t('div', {
                    className: p.formLikeField,
                    children: [
                      a('label', {
                        id: `${F}-label`,
                        className: p.formLikeFieldLabel,
                        htmlFor: s(F),
                        children: e['appSearch.columns.tenant'],
                      }),
                      a('div', {
                        className: p.formLikeFieldControl,
                        children: a(l.Item, {
                          field: 'tenantId',
                          noStyle: !0,
                          children: a(d, {
                            ...
                            children: a(n, {
                              placeholder:
                                e['appSearch.form.tenant.placeholder'],
                              allowClear: !0,
                              options: r.tenantOptions.map((i) => ({
                                label: `${i.tenantName} (${i.tenantCode})`,
                                value: i.id,
                              })),
                            }),
                          }),
            ...
            a(u, {
              ...
              children: a(l.Item, {
                ...
                children: a(v, {
                  allowClear: !0,
                  placeholder: e['appSearch.form.appCode.placeholder'],
                }),
              }),
            }),
            a(u, {
              ...
              children: a(l.Item, {
                ...
                children: a(v, {
                  allowClear: !0,
                  placeholder: e['appSearch.form.pkgName.placeholder'],
                }),
              }),
            }),
            a(u, {
                  ...
                  a('div', {
                    ...
                    children: a(l.Item, {
                      ...
                      children: a(d, {
                        ...
                        children: a(n, {
                          placeholder: e['appSearch.form.os.placeholder'],
                          allowClear: !0,
                          options: [
                            {
              ...
              children: t('div', {
                ...
                children: [
                  a('label', {
                    ...
                    className: p.formLikeFieldLabel,
                    htmlFor: s(S),
                    children: e['appSearch.columns.activeStatus'],
                  }),
                  a('div', {
                    className: p.formLikeFieldControl,
                    children: a(l.Item, {
                      ...
                      children: a(d, {
                        ...
                        children: a(n, {
                          placeholder:
                            e['appSearch.form.activeStatus.placeholder'],
                          allowClear: !0,
                          options: [
                            {
                              label: e['appSearch.activeStatus.enabled'],
                              value: 1,
                            },
                            {
                              label: e['appSearch.activeStatus.disabled'],
                              value: 2,
                            },
                          ],
                        }),
              ...
              children: t('div', {
                ...
                children: [
                  a('label', {
                    ...
                    className: p.formLikeFieldLabel,
                    htmlFor: s(m),
                    children: e['appSearch.columns.status'],
                  }),
                  a('div', {
                    className: p.formLikeFieldControl,
                    children: a(l.Item, {
                      ...
                      children: a(d, {
                        baseId: m,
                        ariaLabelledBy: `${m}-label`,
                        children: a(n, {
                          placeholder: e['appSearch.form.status.placeholder'],
                          allowClear: !0,
                          options: [
                            {
                              label: e['appSearch.dataStatus.normal'],
                              value: 1,
                            },
                            {
                              label: e['appSearch.dataStatus.deleted'],
                              value: 2,
                            },
                          ],
                        }),
      ...
      t('div', {
        ...
        children: [
          a(A, {
            ...
            icon: a(y, {}),
            onClick: B,
            children: e['appSearch.form.search'],
          }),
          a(A, {
            icon: a(w, {}),
            onClick: D,
            children: e['appSearch.form.reset'],
          }),
        ],
      }),
    ],
